     ...
     <div className="md:flex no-wrap md:-mx-2 ">
       ...
       <div className="w-full h-64 mx-2 md:w-9/12">
         ...
         <div className="flex items-center space-x-2 font-bold leading-8 text-indigo-700">
           ...
           <Link to="/yourskills">
           <button className="inline-block px-6 py-3 leading-none text-white rounded shadow bg-amber-500 hover:bg-indigo-600 hover:-translate-y-2">Your Skills</button></Link>
