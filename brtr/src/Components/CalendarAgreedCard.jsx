...
function CalendarAgreedCard({barter, user}) {
  ...
  return (
    ...
    <div className= "mx-auto mt-5 p-10 h-full w-4/6 hover:bg-slate-200 bg-opacity-70 rounded-xl transition ease-in-out duration-200 bg-slate-100 hover:shadow-xl">
     ...
     <p className ="font-extrabold mb-5 flex justify-center text-xl text-transparent transition duration-500 ease-in-out font-heading bg-gradient-to-r bg-clip-text from-indigo-500 via-orange-500 to-indigo-500 animate-text hover:scale-110">In Exchange For</p> 
     <div className="flex justify-center mb-2">
...
export default CalendarAgreedCard