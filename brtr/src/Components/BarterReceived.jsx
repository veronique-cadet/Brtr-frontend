...
//     if (user) return user?.id === barter?.recipient_id;
//     else return barter})
...
return <BarterCardReceived userProfile={userProfile} setUserProfile={setUserProfile} user={user} id={barter.id} setYourBarters={setYourBarters} yourBarters={yourBarters} key={barter.id} barter={barter}/> })
  ...
  <div className="container px-4 mx-auto">
    <div className="relative flex justify-center">
      ...
      <Link to="/receivedbarters"> <li className="p-5"><a className="group relative flex-col items-center text-lg  text-amber-500  hover:text-transparent font-medium bg-clip-text hover:bg-gradient-to-r from-amber-500 " href=""><span className="inline-block pb-5">Recieved Bartrs</span>
        ...
        <li className="p-5"><a className="group relative flex-col items-center text-lg text-indigo-600  hover:text-transparent font-medium bg-clip-text hover:bg-gradient-to-r from-amber-500 " href=""><span className="inline-block pb-5">Agreed Bartrs</span>
