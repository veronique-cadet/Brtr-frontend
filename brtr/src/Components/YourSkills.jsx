  ...
  <div className="container px-4 mx-auto">
    <div className="relative flex justify-center">
      <ul className="relative z-10 inline-flex flex-wrap items-center -m-5">
        ...
        <li className="p-5"><a className="group relative flex-col items-center text-lg text-indigo-600  hover:text-transparent font-medium bg-clip-text hover:bg-gradient-to-r from-amber-500 " href=""><span className="inline-block pb-5">Add Another Skill</span>
          <div className="h-0.5 bg-transparenhover:bg-gradient-purple-left"></div></a></li></Link>
          <Link to="/yourprofile">
        <li className="p-5"><a className="group relative flex-col items-center text-lg text-indigo-600  hover:text-transparent font-medium bg-clip-text hover:bg-gradient-to-r from-amber-500 " href=""><span className="inline-block pb-5">Back To Profile</span>
          <div className="h-0.5 bg-transparenhover:bg-gradient-purple-left"></div></a></li></Link>
