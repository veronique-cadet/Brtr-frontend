      ...
      <div className="flex flex-col items-center justify-center px-4 pt-8 pb-6 border-b border-black-100">
        ...
        <div className="flex flex-wrap justify-between w-full -m-2">
          <div className="w-full p-2 md:w-1/2">
            <button className="flex-wrap justify-center w-full px-4 py-2 text-sm font-medium bg-indigo-500 border rounded-md first-letter:lex text-black-500 hover:text-black-600 border-black-200 hover:border-black-300 shadow-button hover:bg-amber-500">
              <p>Message</p>
            </button>
          </div>
          <div className="w-full p-2 md:w-1/2">
          <Link to="/userprofile" state={{ from: skill }}>
            <button 
            className="flex flex-wrap justify-center w-full px-4 py-2 text-sm font-medium border rounded-md text-black-500 hover:text-black-600 border-black-200 hover:border-black-300 shadow-button bg-amber-500 hover:bg-indigo-600"
            onClick={() => {
