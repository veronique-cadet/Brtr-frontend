...
<NavBarTwo setUser={setUser} />
  ...
  <p className="mb-6 text-sm text-indigo-600 text-center font-bold uppercase tracking-px"> Search For Skilled Professionals to Bartr With</p>
    <h2 className="text-center mb-10 text-6xl font-bold text-transparent transition duration-500 ease-in-out first-letter:leading-none md:text-7xl lg:text-10xl font-heading  bg-gradient-to-r bg-clip-text from-indigo-500 via-orange-500 to-indigo-500 animate-text hover:-translate-y-4">{user?.first_name}, Start Bartering Today!</h2> 
     <div className=" bottom-0 left-0 w-full h-0.5 bg-neutral-100"></div>
  
    <div className="mx-auto mt-8 p-10 h-full w-4/6 hover:bg-slate-200 bg-opacity-70 rounded-xl transition ease-in-out duration-200 bg-slate-100">
