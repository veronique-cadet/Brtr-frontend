        ...
        <div className="flex flex-wrap items-center justify-between -m-2">
          ...
          <div className="w-full md:w-auto p-2">
            <div className="flex flex-wrap justify-between -m-1.5">
              ...
              <Link to="/yourprofile"><button className="flex flex-wrap justify-center w-full px-4 py-2 font-medium text-sm text-slate-500 hover:text-slate-600 border hover:bg-amber-500 bg-white rounded-md shadow-button">
                  <p>Cancel</p>
                </button></Link>
              </div>
              <div className="w-full md:w-auto p-1.5">
        ...
        <div className="w-full md:w-9/12">
          <div className="flex flex-wrap -m-3">
            ...
            <div className="w-full md:w-1/3 p-3">
              ...
              type="text" 
              value={first} onChange={(e) => setFirst(e.target.value)}/></div>
            <div className="w-full md:w-1/3 p-3">
              <input 
              className="w-full px-4 py-2.5 text-base text-slate-900 font-normal outline-none focus:border-amber-500 border border-slate-200 rounded-lg shadow-input" 
              type="text" 
        ...
        <div className="w-full md:w-9/12">
          <div className="flex flex-wrap -m-3">
            ...
            <div className="w-full md:w-auto p-3">
              <img className="rounded-full w-20 h-20"src={user?.picture}/></div>
            <div className="w-full md:flex-1 p-3">
      ...
      <div className="py-6 border-b border-slate-100">
        <div className="w-full md:w-9/12">
          <div className="flex flex-wrap -m-3">
            ...
            <div className="w-full md:flex-1 p-3">
              <input className="w-full px-4 py-2.5 text-base text-slate-900 font-normal outline-none focus:border-amber-500 border border-slate-200 rounded-lg shadow-input" type="text" placeholder="johndoe@flex.co"  value={city} onChange={(e) => setCity(e.target.value)}/></div>
          </div>
        </div>
      </div>
      <div className="py-6 border-b border-slate-100">
        <div className="w-full md:w-9/12">
          <div className="flex flex-wrap -m-3">
            ...
            <div className="w-full md:flex-1 p-3">
              <input className="w-full px-4 py-2.5 text-base text-slate-900 font-normal outline-none focus:border-amber-500 border border-slate-200 rounded-lg shadow-input" type="text" placeholder="johndoe@flex.co"  value={state} onChange={(e) => setState(e.target.value)}/></div>
          </div>
        </div>
      </div>
      ...
      <div className="pt-6">
        <div className="w-full md:w-9/12">
          <div className="flex flex-wrap -m-3">
            ...
            <div className="w-full md:flex-1 p-3"><textarea className="block w-full h-64 p-6 text-base text-slate-900 font-normal outline-none focus:border-amber-500 border border-slate-200 rounded-lg shadow-input resize-none"  value={bio} onChange={(e) => setBio(e.target.value)}></textarea></div>
          </div>
        </div>
      </div>
    </div>
