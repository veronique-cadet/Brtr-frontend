    ...
    if (otherUser) {
      return (
        <option key={b.id} value={b.id}>
          You and {otherUser} - {b.proposer_skill.name} and{" "}
          {b.recipient_skill.name}
        </option>
      );
    }
  });
                ...
                <div className="flex flex-wrap items-center justify-between -m-2">
                  <div className="w-full md:w-auto p-2">
                    ...
                    <p className="text-xs text-indigo-700 font-medium">
                      Look at you teaching skills and shit!
                    </p>
                  </div>
                  <div className="w-full md:w-auto p-2">
                    <div className="flex flex-wrap justify-between -m-1.5">
                      <div className="w-full md:w-auto p-1.5">
                        <Link to="/calendar">
                          <button className="flex flex-wrap justify-center w-full px-4 py-2 font-bold text-sm text-slate-500 hover:bg-indigo-500 hover:text-white  bg-white rounded-md shadow-button">
                            Cancel
                          </button>
                        </Link>
                      </div>
                      <div className="w-full md:w-auto p-1.5">
                        {isClicked ? (
                          <button
                            ...
                            className="flex flex-wrap justify-center w-full px-4 py-2 bg-amber-500 hover:bg-indigo-500 font-medium text-sm text-white border rounded-md shadow-button"
                          >
                            <p>Schedule Brtr!</p>{" "}
                          </button>
                        ) : (
                          <button className="flex flex-wrap justify-center w-full px-4 py-2 bg-amber-500 hover:bg-indigo-500 font-medium text-sm text-white border rounded-md shadow-button">
                            <p>Scheduled!</p>{" "}
                          </button>
                        )}
                      </div>
                    ...
                    <div className="w-full md:flex-1 p-3">
                      <div className="relative">
                        <select
                          ...
                          className=" w-full py-2.5 px-4 text-slate-900 text-base font-normal bg-white border outline-none border-slate-200 focus:border-amber-500 rounded-lg shadow-input"
                        >
                          {userSkills}
                        </select>
                      </div>
