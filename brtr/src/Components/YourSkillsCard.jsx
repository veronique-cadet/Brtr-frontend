      ...
      {isClicked ? (
          ...
          <div className="flex-col justify-start mb-10">
            <div className="flex justify-evenly">
              <div className="flex ">
                ...
                <p className="text-xl">{userSkill?.name}</p>
              </div>
              <div className="flex ">
                <p className="text-xl font-bold text-indigo-500">
                  Years of Experience:&nbsp;
                ...
                <p className="text-xl">
                  {" "}
                  {userSkill?.years_exp === 1
                    ? userSkill?.years_exp + " year"
                    : userSkill?.years_exp + " years"}
                </p>
              </div>
              <div className="flex">
                <p className="text-xl font-bold text-indigo-500">
                ...
                <p className="text-xl"> {userSkill?.proof_url}</p>
              </div>
            </div>
            <div className="flex-col justify-center mt-5 ">
              <p className=" flex justify-center text-xl font-bold text-indigo-500">
                Skill Description:&nbsp;
              </p>
        ...
        <div className="mx-auto mt-5 p-10 h-full w-4/6 hover:bg-slate-200 bg-opacity-70 rounded-xl transition ease-in-out duration-200 bg-slate-100 hover:shadow-xl">
          <div className="flex-col justify-start mb-10">
            ...
            <div className="flex-col justify-center mt-5 ">
              <p className=" flex justify-center text-xl font-bold text-indigo-500 mb-2">
                Skill Description:&nbsp;
              </p>{" "}
              <textarea
                className="block w-full h-64 p-6 text-base text-slate-900 font-normal outline-none focus:border-amber-500 border border-slate-200 rounded-lg shadow-input resize-none"
                value={proof}
